...
function show_APN_list(){
	...
	if(document.form.modem_country.value == ""){
		inputCtrl(document.form.modem_isp, 0);
		inputHideCtrl(document.form.modem_autoapn, 1);
		...
		inputHideCtrl(document.form.modem_autoapn, 0);
...
function applyRule(){
	...
	if(document.form.modem_country.value == ""){
		...
		document.form.modem_autoapn.value = "0"; //Disable AutoAPN
			...
			<td bgcolor="#4D595D" valign="top" height="680px">
				...
				<table id="traffic_table" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable" style="margin-top:8px">
				  ...
				  <tr>
					...
					<td>
					  <input type="text" maxlength="15" class="input_15_table" id="data_limit" name="data_limit" value="" onkeypress="return validator.isNumberFloat(this,event)" onchange="change_limit_value();" autocorrect="off" autocapitalize="off"/>
					  	<span>
				  ...
				  <tr>
					...
					<td>
					  <input type="text" maxlength="15" class="input_15_table" id="data_warning" name="data_warning" value="" onkeypress="return validator.isNumberFloat(this,event);" autocorrect="off" autocapitalize="off"/>
					  	<span>
			  	...
			  	<table id="apn_table" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable" style="margin-top:8px">
					...
					<tr id="modem_autoapn_tr" style="display:none">
						<th width="40%">Auto APN</th>
						<td>
							<select name="modem_autoapn" id="modem_autoapn" class="input_option" onchange="">
								<option value="1" <% nvram_match("modem_autoapn", "1","selected"); %>><#WLANConfig11b_WirelessCtrl_button1name#></option>
								<option value="0" <% nvram_match("modem_autoapn", "0","selected"); %>><#WLANConfig11b_WirelessCtrl_buttonname#></option>
							</select>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input id="modem_dialnum" name="modem_dialnum" class="input_20_table" type="text" value="" autocorrect="off" autocapitalize="off"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
						<input id="modem_user" name="modem_user" class="input_20_table" type="text" value="<% nvram_get("modem_user"); %>" autocorrect="off" autocapitalize="off"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input id="modem_pass" name="modem_pass" class="input_20_table" type="password" value="<% nvram_get("modem_pass"); %>" autocorrect="off" autocapitalize="off"/>
						</td>
					</tr>
