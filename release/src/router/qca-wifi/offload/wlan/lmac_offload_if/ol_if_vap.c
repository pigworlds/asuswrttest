...
struct ieee80211vap *vv_first_vap=NULL;
struct ol_ath_softc_net80211 *vv_first_vap_scn=NULL;
/*
 * VAP create
 */
...
#define ATH_NSCAN_PSTA_VAPS 0
    ...
    if (id==0) {
	if (vv_first_vap)
		printk("WARNING!!!, create first_vap without delete???\n");
	vv_first_vap=vap;
	vv_first_vap_scn=scn;
    }
    return vap;
